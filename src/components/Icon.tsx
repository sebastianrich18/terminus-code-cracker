  ...
  const renderSVG = () => {
    switch (type) {
      ...
      case 'icon2':
        return (
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
            <circle cx="50" cy="60" r="20" fill="white" stroke="black" strokeWidth="2"/>
      ...
      case 'icon3':
        return (
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
            <circle cx="60" cy="40" r="20" fill="white" stroke="black" strokeWidth="2"/>
      ...
      case 'icon4':
        return (
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="-20 -20 140 140">
            <ellipse cx="50" cy="23" rx="15" ry="35" fill="white" stroke="black" strokeWidth="2"/>
            <ellipse cx="50" cy="77" rx="15" ry="35" fill="white" stroke="black" strokeWidth="2"/>
      ...
      case 'icon5':
        return (
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="-20 -20 140 140">
            <ellipse cx="31" cy="31" rx="12" ry="35" fill="white" stroke="black" strokeWidth="2" transform="rotate(-45 31 31)"/>
            <ellipse cx="69" cy="69" rx="12" ry="35" fill="white" stroke="black" strokeWidth="2" transform="rotate(-45 69 69)"/>
